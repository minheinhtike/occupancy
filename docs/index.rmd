...
![image](C:/git/occupancy/images/Banner.png)
...
![image](C:/git/occupancy/images/Gaur Occupancy.png)
...
detection probability increases with more date (positive estimate)
occupancy probability increases with forest cover (positive estimate) and increase with elevation as well (positive estimate)
...
![image](C:/git/occupancy/images/OIP.jpg)
